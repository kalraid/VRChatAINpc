...
//			limit	Integer	반환 Row 수		10	200
	...
	public ResponseEntity<?> getCharacterBaseInfo(CharacterVO cvo) {
...
//		characterId	String	캐릭터 고유 코드	Y
		...
		String url = "https://api.neople.co.kr/df/servers/"+cvo.getServerId()+"/characters?characterName="+cvo.getName()+"&apikey="+key;
		ResponseEntity<?> entity = apiService.get(url);
